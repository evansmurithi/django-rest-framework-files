...
FLAKE8_ARGS = ['rest_framework_files', 'tests', '--ignore=E501']

ISORT_ARGS = ['--recursive', '--check-only', '-o' 'uritemplate', '-p', 'tests', 'rest_framework_files', 'tests']
    ...
    if len(sys.argv) > 1:
        ...
        try:
            ...
            pytest_args = [
                ...
                'xml',
                '--cov',
                'rest_framework_files'] + pytest_args
